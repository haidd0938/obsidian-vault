...
# === 每日覆盖注入 ===
VIDEO_TITLE = '中央财政砸8-12亿！城市更新行动2026年重磅启动，建筑企业的新风口来了？'
BRAND_NAME = '东盛建筑设计'
BRAND_SUBTITLE = '设计 · 勘察 · 施工 · EPC总承包'
SCENES_TEXTS = ['重磅消息！财政部联合住建部刚刚发文：2026年中央财政继续砸重金支持城市更新行动！每座城市最高补贴12个亿！这不是画饼，是真金白银！', '但注意了——这次只选不超过15个城市，东部每个城市补贴不超过8亿，中部10亿，西部12亿。竞争性评审，120%差额答辩，跟申请国家科学基金一样卷！', "钱花在哪？两个方向：一是重点样板片区建设，修管网、做适老化、提品质；二是建机制——探索可持续的城市更新投融资模式。重点在'老城区'，不是新区开发。", '为什么说城市更新是EPC从业者的最大机会？因为城市更新不是单一工程，而是设计、施工、投资、运营一体化。传统施工队干不了，设计院单干也不行——只有EPC总承包模式才能打通全过程。', '住建部之前发文要求完善城市更新工程项目建设管理机制，分类优化审批流程。说白了，城市更新的门槛比新建项目更高，更需要专业的一体化服务能力。这就是EPC企业的护城河。', '东盛建筑设计，十五年深耕建筑行业。从方案设计到施工管控，从勘察测绘到EPC总承包——我们提供城市更新一站式闭环服务。城市更新大时代，东盛和你一起把握！', '你所在的城市有城市更新项目吗？你觉得8-12亿补贴够不够？评论区聊聊。关注东盛建筑，每天解读一个行业热点。点赞转发，让做工程的朋友都看到！']
# === 结束覆盖 ===
